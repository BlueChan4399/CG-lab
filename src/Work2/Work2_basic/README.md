...
![原始三角形](cg_work2_demo1.gif)

### Demo 2：修改颜色

修改三角形三条边的颜色配置。

![修改颜色](cg_work2_demo2.gif)

### Demo 3：修改三角形形状

通过调整顶点坐标改变三角形的形状。

![修改三角形形状](cg_work2_demo3.gif)

### Demo 4：修改形状为正方形

将顶点扩展为四个，渲染为正方形。

![修改形状为正方形](cg_work2_demo4.gif)
...
├── main.py          # 主程序入口与渲染循环
├── cg_work2_demo1.gif  # Demo 1 效果图
├── cg_work2_demo2.gif  # Demo 2 效果图
├── cg_work2_demo3.gif  # Demo 3 效果图
└── cg_work2_demo4.gif  # Demo 4 效果图
```
