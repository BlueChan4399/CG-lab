# CG-Lab7 - Mass-Spring Cloth Simulation
...
| :---: | :---: |
| ![改变 k_s](gif/work7_change_ks.gif) | ![改变 k_d](gif/work7_change_kd.gif) |
| *k_d 不变，实时 k_s 大小调节、三种积分方法对比* | *k_s 不变，实时 k_d 大小调节、三种积分方法对比* |

| 极端值 k_s | 极端值 k_d |
| :---: | :---: |
| ![极端 k_s](gif/work7_damping=0.gif) | ![极端 k_d](gif/work7_stiffness=2500.gif) |
...
| :---: | :---: |
| ![弹簧消融](gif/work7_optional_spring_ablation.gif) | ![弹簧对比](gif/work7_optional_shear_vs_bending.gif) |
...
| :---: | :---: |
| ![桌布罩球](gif/work7_optional_sphere_drape.gif) | ![球体扫掠](gif/work7_optional_sphere_sweep.gif) |
