# CG-Lab6 — Differentiable Mesh Deformation via Silhouette Optimization
...
![必做实验 MeshLab 动画](visualization/cg_Work6_demo1.gif)
...
![选做实验 MeshLab 动画](visualization/cg_Work6_demo2.gif)
...
├── Work6.ipynb            # 主实验 Notebook（3 个 cell）
...
在 Jupyter Notebook / VS Code 中打开 `Work6.ipynb`，按顺序执行三个 Cell：
